...
var component = exports.component = function component(data) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'Stylizacja 1.: kurtka: The House Of Bruar / beret: Stradivarius / torebka: Tania Odzie\u017C x Olela / bi\u017Cuteria: Yes, H&M Stylizacja 2.: kurtka: Ochnik / sp\xF3dnica: Reserved / beret: Stradivarius / pasek: TK Maxx'
    )
  );
};
