...
paramorph.addPage(
  new Category(
    "/sztuka-ubioru/",
    "Sztuka Ubioru",
    "Sztuka Ubioru: Wenus vs Chanel, czyli_Nowa Dziewczyna z_Perłą, Podlewaj_swoje_kwiaty., Cała_Ta_J..., Stylizacje za grosze, czyli pokochaj lumpeksy!, Moje wybory: grudzień, Moje wybory: styczeń, O narkotykach XXI wieku, Moje wybory: marzec, Moje wybory: kwiecień, Moje wybory: luty, RGB. Trzy stylizacje z mojej szafy, Moje wybory: czerwiec/lipiec, cz.",
    null,
    "Categories",
    "ParrotLayout",
...
paramorph.addPage(
  new Category(
    "/sztuka-dla-sztuki/",
    "Sztuka dla Sztuki",
    "Sztuka dla Sztuki: Neoplastycyzm [moodboard], Uniwersalność Sztuki, KOŁO [moodboard], POP-ART [moodboard], Fuerteventura impressions, Minimalizm [moodboard], Kubizm [moodboard], Wystawa: Pablo_Picasso – wizerunek wielokrotny, Kolaż_okładek., Surrealizm [moodboard], Wystawa: Inny Trans-Atlantyk. Sztuka kinetyczna i op-art w Europie Wschodniej i Ameryce Łacińskiej w latach 50. – 70., Action_Painting [moodboard], Kolagen, Impresjonizm [moodboard], Op-art [moodboard], Wystawa: David Lynch.",
    null,
    "Categories",
    "ParrotLayout",
