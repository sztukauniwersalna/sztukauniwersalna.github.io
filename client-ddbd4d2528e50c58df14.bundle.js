...
var ClientRenderer = /** @class */ (function () {
    ...
    ClientRenderer.prototype.render = function (containerId) {
        ...
        var initialPage = pages[this.getCurrentPathname()] || notFound;
    ...
    ClientRenderer.prototype.getCurrentPathname = function () {
